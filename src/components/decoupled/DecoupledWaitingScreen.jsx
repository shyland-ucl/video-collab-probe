    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-lg mx-auto px-4">
        <OnboardingBrief
          ...
          description={`You are the ${role}. Waiting for the ${role === 'creator' ? 'helper' : 'creator'} to connect. Ask them to open this same page on their phone and select their role. The session will start automatically once both people are connected.`}
        />
