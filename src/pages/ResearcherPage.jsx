...
export default function ResearcherPage() {
  ...
  // Condition active tracking
  const [activeConditions, setActiveConditions] = useState({});

  // Auto-scroll ref for event log
  ...
  // Session config from localStorage
  ...
  const handleSessionToggle = useCallback(() => {
    if (sessionActive) {
      logEvent(EventTypes.SESSION_END, Actors.RESEARCHER, {
  ...
  // Probe 2 suggestion handler (no-op in standalone panel)
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Navy header */}
      <header
        className="w-full px-4 py-3 flex items-center gap-4 flex-wrap"
      ...
      >
        ...
        <span className="text-white/60 text-sm ml-auto">
          Video Collaboration Research Tool
        </span>
      </header>
      ...
      <div className="max-w-7xl mx-auto p-4 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div>
              ...
              <p className="text-sm font-mono text-gray-800">
                {sessionConfig.sessionId || 'Not set'}
              </p>
            </div>
            ...
            <div className="border-l border-gray-200 pl-4">
              ...
              <p className="text-sm font-mono text-gray-800" aria-live="polite">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
                ...
                {CONDITIONS.map((cond) => (
                  <button
                    ...
                    className={[
                      ...
                      selectedTab === cond.key
                        ? 'border-b-2 text-gray-900'
                        : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50',
                    ].join(' ')}
                    style={
                      selectedTab === cond.key
                        ? { borderBottomColor: cond.color }
                        : undefined
                    }
                    role="tab"
              ...
              <div className="p-4" role="tabpanel">
                {/* Condition start/end button at top of every tab */}
                <div className="mb-4 flex items-center gap-3">
                  <button
                    ...
                    style={{
                      backgroundColor: activeConditions[selectedTab]
                        ? '#D9534F'
                        : COLORS.green,
                    }}
                    aria-label={
                      activeConditions[selectedTab]
                        ? `End ${selectedTab} condition`
                        : `Start ${selectedTab} condition`
                    }
                  >
                    {activeConditions[selectedTab]
                        ...
                        <div className="flex flex-wrap gap-1">
                          {segments.map((seg) => (
                            <button
                              ...
                              aria-label={`Select segment: ${seg.label || seg.id}`}
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        ...
                        style={{
                          backgroundColor:
                            currentMode === 'creator' ? COLORS.blue : '#E67E22',
                        }}
                      >
                ...
                {selectedTab === 'probe3' && (
                  <div className="space-y-4">
                    <div
                      ...
                      style={{ borderColor: COLORS.amber, backgroundColor: '#FFFBF0' }}
                    >
                      ...
                      <p className="text-xs text-gray-500 mb-3">
                        Use these controls if WebRTC connection fails.
                      </p>
                      <div className="flex gap-2 flex-wrap items-end">
                        <button
                          ...
                          aria-label="Manual play command"
                        >
                          Play
                        </button>
                        <button
                          ...
                          aria-label="Manual pause command"
                        >
                          Pause
                        </button>
                        <div className="flex items-end gap-1">
                          <div>
                            ...
                            <input
                              ...
                              className="w-24 px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-2 focus:outline-blue-500"
                          ...
                          <button
                            ...
                            aria-label="Manual seek command"
                          >
                            Seek
                          </button>
                        </div>
                      ...
                      <p className="text-xs text-gray-400 mt-3">
                        Connection status: Events are logged but actual sync
                        requires the probe3 page to be active with WebRTC.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="px-4 py-3 border-b border-gray-200 flex flex-wrap items-center gap-3">
                ...
                <div className="ml-auto flex items-center gap-2">
                  <select
                    ...
                    className="px-2 py-1 border border-gray-300 rounded text-xs focus:outline-2 focus:outline-blue-500"
                      ...
                      filteredEvents.map((evt, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td
                              className="px-3 py-1.5 font-mono text-gray-500 max-w-xs truncate"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  style={{
                    backgroundColor: sessionActive ? '#D9534F' : COLORS.green,
                  }}
                  aria-label={
                  ...
                  <div className="space-y-1.5">
                    {CONDITIONS.map((cond) => (
                      <button
                        ...
                        style={{
                          backgroundColor: activeConditions[cond.key]
                            ? '#D9534F'
                            : cond.color,
                        }}
                        aria-label={
                  ...
                  {showClearConfirm ? (
                    <div className="space-y-2">
                      <p className="text-xs text-red-600 font-medium">
                        Are you sure? This will delete all logged events.
                      </p>
                      <div className="flex gap-2">
                        <button
                          onClick={handleClearLog}
                          className="flex-1 py-1.5 rounded text-xs font-medium text-white bg-red-600 focus:outline-2 focus:outline-offset-2 focus:outline-red-600"
                        ...
                        <button
                          ...
                          className="flex-1 py-1.5 rounded text-xs font-medium text-gray-700 bg-gray-200 focus:outline-2 focus:outline-offset-2"
                          aria-label="Cancel clear log"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    <button
                      ...
                      className="w-full py-1.5 rounded text-xs font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors focus:outline-2 focus:outline-offset-2"
            ...
            {/* Quick links to condition pages */}
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
              <h2
              ...
              <div className="space-y-1.5">
                ...
                <a
                  ...
                  className="block px-3 py-2 rounded text-sm text-gray-600 hover:bg-gray-50 transition-colors focus:outline-2 focus:outline-blue-500"
                  aria-label="Probe 1 with researcher mode"
                >
                  Probe 1 (Researcher Mode)
                </a>
                <a
                  href="/probe2?mode=researcher"
                  className="block px-3 py-2 rounded text-sm text-gray-600 hover:bg-gray-50 transition-colors focus:outline-2 focus:outline-blue-500"
                  aria-label="Probe 2 with researcher mode"
                >
                  Probe 2 (Researcher Mode)
                </a>
                <a
                  href="/probe3?mode=researcher"
                  className="block px-3 py-2 rounded text-sm text-gray-600 hover:bg-gray-50 transition-colors focus:outline-2 focus:outline-blue-500"
                  aria-label="Probe 3 with researcher mode"
                >
                  Probe 3 (Researcher Mode)
                </a>
              </div>
            </div>
          </div>
