...
- **Suggested command**: Which command to use (prefer:  — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: . You may also suggest other installed skills you're sure exist, but never invent commands.
